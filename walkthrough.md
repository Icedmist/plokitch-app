...
* **Details**:
  ...
  * **Post-Frame Login Toast Trigger**: Configured the top-sliding login alert toast to slide down on the target dashboard landing page inside [main_navigation_shell.dart](file:///home/adam/Projects/plokitch-app/lib/screens/main_navigation_shell.dart#L34) by utilizing a post-frame callback (`addPostFrameCallback`) and arguments passed from sign-in. This resolves the route-switching context disposition bug and ensures the login notification toast displays fully.
